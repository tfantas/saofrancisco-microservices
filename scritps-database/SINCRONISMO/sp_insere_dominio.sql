...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Procedure SP_INSERE_DOMINIO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "SINCRONISMO"."SP_INSERE_DOMINIO" 
(
    v_nm_origem_a VARCHAR2,
    v_nm_coluna_a VARCHAR2,
    v_cod_valor_a VARCHAR2,
    v_nm_origem_b VARCHAR2,
    v_nm_coluna_b VARCHAR2,
    v_cod_valor_b VARCHAR2
)
IS
    v_a_p1     INTEGER;
    v_a_p2     INTEGER;
...
BEGIN
    ...
    INSERT INTO DOMINIO (cod_coluna_origem, valor_origem, cod_coluna_destino, valor_destino)
