...
*/
ALTER TABLE CONTRATO.PRECO_ITEM ADD CONSTRAINT PRECO_ITEM_DETALHE2_FK FOREIGN KEY ( COD_PRECO_ITEM_DETALHE ) REFERENCES CONTRATO.PRECO_ITEM_DETALHE ( COD_PRECO_ITEM_DETALHE ) NOT DEFERRABLE ;
